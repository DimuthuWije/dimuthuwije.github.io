...
<div class="row">
    <div class="col-sm mt-3 mt-md-0">
        ...
        <iframe
            src="https://www.youtube.com/embed/FOzZonxdn7Y"
            title="Quadruped Robot project video"
            loading="lazy"
...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid
        path="assets/img/projects/QuadrupedRobotParts.jpg"
        title="3D-printed quadruped robot components"
        class="img-fluid rounded z-depth-1" %}
    </div>

    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid
        path="assets/img/projects/QuadrupedRobotServos.jpg"
...
<div class="row justify-content-sm-center">
    ...
    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid
        path="assets/img/projects/QuadrupedRobotTwoLegs.jpeg"
        title="Leg assembly with integrated servo actuators"
        class="img-fluid rounded z-depth-1" %}
    </div>

    <div class="col-sm-6 mt-3 mt-md-0">
        {% include figure.liquid
        path="assets/img/projects/QuadrupedRobotAssembled.jpg"
...
<div class="row justify-content-center">
    ...
    <div class="col-sm-8 mt-3 mt-md-0">
        {% include figure.liquid
        path="assets/img/projects/QuadrupedLocomotion.gif"
        title="Quadruped robot locomotion demonstration"
        class="img-fluid rounded z-depth-1" %}
    </div>
